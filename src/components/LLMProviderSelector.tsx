...
export const LLMProviderSelector = ({ onChange }) => {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="mb-1 block text-sm font-medium text-pink-500">LLM Provider</label>
        <select
          value={provider}
          onChange={handleProviderChange}
          className="w-full rounded border border-pink-500 bg-black p-2 text-pink-500"
        >
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-pink-500">Model</label>
        <select
          value={model}
