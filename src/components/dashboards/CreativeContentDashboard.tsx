          ...
          <Tabs defaultValue="generation">
            ...
            <TabsContent value="generation">
              <div className="space-y-4 mt-4">
                <Button 
                  className="w-full" 
                  onClick={() => handleGenerateContent('text-to-image')}
                >
                ...
                <Button 
                  className="w-full"
                  onClick={() => handleGenerateContent('image-to-image')}
                >
                  <Image className="mr-2 h-4 w-4" />
                  Image to Image
                </Button>
                ...
                <Button 
                  className="w-full"
                  onClick={() => handleGenerateContent('text-to-video')}
                >
                ...
                <Button 
                  className="w-full"
                  onClick={() => handleGenerateContent('image-to-video')}
                >
                  <Video className="mr-2 h-4 w-4" />
                  Image to Video
                </Button>
