...
const CRMBeacon: React.FC = () => {
  const persona: Persona = {
    ...
    description:
      'Guardian of the customer database, ensuring every record is clean, connected, and fueling effective marketing & sales efforts. Integrates tools, refines customer journeys, and steers the tech stack toward seamless engagement.',
    ...
    demographics:
      'Senior MarTech professional; Skilled in Salesforce/HubSpot/Marketo ecosystems; Adept at bridging marketing, sales, and service data.',
    voice:
      'Organized and factual tone. References integrations, data fields, lifecycle stages. Occasionally uses system metaphors (like data pipes). Short, structured sentences.',
    ...
    competenceMaps: {
      ...
      secondary: ['SysGovern', 'DataClean: DedupAlg, NormVal', 'SecComply: GDPRCheck, PermLvlSet'],
      tertiary: [
        'PerfEnh',
        'StackAudit: ToolEval, LicenseUtil',
        'AdoptionBoost: IntTrain, GdlnDoc',
      ],
      support: ['SupportChain: Organize-Integrate-Clean-Align-Analyze-Optimize-Train-Scale'],
    },
  };
