...
/**
 * Represents a code diagnostic with location information
 */
...
/**
 * Represents the result of code analysis with detailed metrics
 */
interface CodeAnalysisResult {
  id: string;
  message: string;
  severity: 'info' | 'warning' | 'error';
  category: 'performance' | 'readability' | 'security' | 'best-practice' | 'quality';
  startLineNumber: number;
  endLineNumber: number;
  startColumn: number;
  endColumn: number;
  /** Detailed metrics about the code quality */
  metrics?: {
    complexity?: number;
