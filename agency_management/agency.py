class Agency:
    def __init__(self):
        self.departments = {
            ...
            'creative_content': CreativeContentDepartment(),
            'digital_marketing': DigitalMarketingDepartment(),
    ...
    def _extract_persona_name(self, persona_data):
        """Extract persona name from persona data"""
        # Look for the persona name in the data
        if "Persona:" in persona_data:
            return persona_data.split("Persona:")[1].split("\n")[0].strip()
    ...
    def assign_persona(self, persona_path):
        ...
        try:
            with open(persona_path, 'r') as f:
                ...
                # Add additional specializations based on persona content
...
class AtomicAgent:
    ...
    def perform_task(self, task):
        ...
        if task_type in self.capabilities:
            ...
            self._execute_persona_task(task)
        else:
    ...
    def _execute_persona_task(self, task):
        ...
        try:
            # Execute task based on persona capabilities
            if "Marketing Automation" in self.capabilities:
                self._execute_marketing_task(task)
            elif "Data Analysis" in self.capabilities:
                self._execute_analysis_task(task)
            elif "CRM Integration" in self.capabilities:
                self._execute_crm_task(task)
            else:
    ...
    def _execute_marketing_task(self, task):
        ...
        # Implementation would include marketing-specific logic
        # based on the loaded persona data
        pass
        
    def _execute_analysis_task(self, task):
        """Execute data analysis task"""
        # Implementation would include analysis-specific logic
        # based on the loaded persona data
        pass
        
    def _execute_crm_task(self, task):
        """Execute CRM-related task"""
        # Implementation would include CRM-specific logic
        # based on the loaded persona data
        pass
...
if __name__ == "__main__":
    ...
    agency.departments['creative_content'].add_staff(
        Employee('Alex', 'Creative Director')
    )
    agency.departments['digital_marketing'].add_staff(
