  ...
  $.widget('ui.selectmenu', {
    ...
    _create: function () {
      ...
      this.newelement = $(
        '<a class="' +
          ...
          this.ids[0] +
          '" role="button" href="#" tabindex="0" aria-haspopup="true" aria-owns="' +
          this.ids[1] +
          '"></a>'
        ...
        var thisLi = $(
          '<li role="presentation"' +
            (selectOptionData[i].disabled
              ? ' class="' + this.namespace + '-state-disabled' + '"'
              : '') +
            '><a href="#" tabindex="-1" role="option"' +
            (selectOptionData[i].disabled ? ' aria-disabled="true"' : '') +
            ' aria-selected="false"' +
            (selectOptionData[i].typeahead
              ? ' typeahead="' + selectOptionData[i].typeahead + '"'
              : '') +
            '>' +
    ...
    open: function (event) {
      ...
      if (this.newelement.attr('aria-disabled') != 'true') {
        ...
        this.list
          .find(
            'li:not(.' + self.widgetBaseClass + '-group):eq(' + this._selectedIndex() + ') a'
          )[0]
          .focus();
    ...
    _refreshPosition: function () {
      ...
      if (o.style == 'popup' && !o.positionOptions.offset) {
        ...
        var _offset =
          '0 -' + (selected.outerHeight() + selected.offset().top - this.list.offset().top);
      }
      this.list
        .css({
